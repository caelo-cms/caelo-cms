...
export function isStatusNote(m) {
...
export function noteMarkerKind(content) {
...
export function isContextNote(content) {
...
export function contextNoteLabel(content) {
 ...
 */
export function statusNoteKey(content) {
    return content
        .trim()
        .toLowerCase()
 ...
 */
export function collapseStatusNotes(messages) {
    const out = [];
