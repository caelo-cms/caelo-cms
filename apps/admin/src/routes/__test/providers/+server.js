 ...
 */
import { clearAllTestProviders, clearTestProvider, isTestRegistryEnabled, registerTestProvider, } from "@caelo-cms/admin-core";
...
export const POST = async ({ request }) => {
    ...
    registerTestProvider(body.name, body.events);
