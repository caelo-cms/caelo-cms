 ...
 */
import { deriveCeilingFromEstimate, ESTIMATE_CEILING_SAFETY_FACTOR, formatMicrocentsAsMoney, } from "@caelo-cms/admin-core";
...
export const actions = {
    approve: async ({ request, locals }) => {
        ...
        const v = r.value;
        const budgetNote = v.ceilingMicrocents !== null && v.ceilingCurrency !== null
