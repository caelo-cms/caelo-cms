...
<div class="space-y-6">
  <div>
    <h1 class="text-2xl font-semibold tracking-tight">Pending role actions</h1>
    <p class="text-sm text-muted-foreground">
      AI-proposed role create / permission-change / delete actions wait here for your click. The
      preview shows added/removed permissions and the count of users currently in the role so you
  ...
  {#if data.proposals.length === 0}
    <Card>
      <CardContent class="py-12 text-center text-sm text-muted-foreground">
        No pending role proposals. AI-driven role changes will land here.
      </CardContent>
    </Card>
  {:else}
    <div class="space-y-4">
