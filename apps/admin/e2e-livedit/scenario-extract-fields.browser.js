...
const EXTRACT_PROMPT = "Please add a new module to the homepage's content block at position 0. " +
...
function snapshotWelcomeHeroModule() {
...
test("AC #1: extractor produces {{title}} + {{ctaHref}} + {{ctaLabel}} for hardcoded HTML", async ({ page, }) => {
    ...
    const copyPreserved = defaults.some((d) => d.includes("Welcome")) ||
