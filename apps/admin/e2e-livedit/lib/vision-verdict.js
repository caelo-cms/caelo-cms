 ...
 */
export function parseVisionVerdict(responseJson) {
 ...
 */
export function parseVerdictJsonText(text) {
 ...
 * cannot recover.
 */
export async function fetchVisionVerdict(opts) {
