...
import { attachTestProviderHeader, clearLoginRateBucket, clearTestProvider, registerTestProvider, runBunInline, } from "./helpers.js";
test.beforeAll(() => {
...
test("AI generate_image persists a media asset via the fake image provider", async ({ context, page, }) => {
